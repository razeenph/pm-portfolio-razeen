...
|----------|--------------|------------|
| [Rapido Food Delivery Case](./rapido-food-case/README.md) | A full PM case converting bike-hailing → food delivery | PRD · Roadmap · Figma Wireframes · Power BI Dashboard · Jira Screens |
| [Amazon Compliance Tool Improvement](./amazon-compliance-product) | Process-to-product improvement proposal for internal software | Mini-PRD · Workflow Diagram · Impact Analysis |
